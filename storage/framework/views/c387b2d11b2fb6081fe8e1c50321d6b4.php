...
<div class="container mt-5">
    <div class="card shadow p-4">
        ...
        <form method="POST" action="<?php echo e(route('generate.letter')); ?>">
            <?php echo csrf_field(); ?>
            <div class="mb-3">
...
</html><?php /**PATH C:\leave-letter-generator\leave-letter-app\resources\views/form.blade.php ENDPATH**/ ?>